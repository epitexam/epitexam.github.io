...
draft: false
tags: ['portfolio', 'dev junior', 'astros', 'hugo', 'jekyll', 'gratuit', 'hébergement', 'performance', 'accessibilité', 'sécurité']
---
...
Et puis, petit à petit, le dev s’est retrouvé dans la mêlée.

Le portfolio est devenu l'extension de son CV et la pratique s'est généralisé à tous les milieu. L’objectif est clair : prouver que tu sais faire ce que tu dis savoir faire.
<br/>
...
Il se peut que recruteur qui ouvre ton site entre deux réunions, souvent sur mobile et en 4G.
...
<br/>
L’accessibilité n’est pas réservée aux grosses plateformes : c’est nécéssaire meme pour les petits projets. 
...
Quelques bonnes pratiques suffisent : une meta description claire, des titres propres sur chaque page, et des balises OpenGraph pour éviter que ton lien ressemble à un écran gris quand tu le postes sur LinkedIn ou un serveur Discord.
...
Astro brille particulièrement pour les portfolios un peu stylés, avec transitions propres, composants réutilisables et Markdown intégré.
...
| [**Neocities**](https://neocities.org/)               | Ambiance rétro Geocities, communauté fun                 | 1 Go stockage max, pas de CI/CD                          | Gratuit – 1 Go stockage – ~200 Go bande passante/mois                                | Sites perso fun, portfolios rétro        |
...
| **HSTS**               | Contourner le HTTP         | Forcer HTTPS 1 an         |
| **X-Frame-Options**    | Clickjacking               | `DENY`                    |
| **Referrer-Policy**    | Fuite d’URL sensibles      | `strict-origin`           |
| **Permissions-Policy** | API abusives               | Désactiver caméra, géoloc |
| **Cache-Control**      | Versions périmées          | `max-age=31536000`        |
...
On ne vas pas ici rentrer en détail de la cybersécurité ou présenter des bouts de code à la va-vite ( bien qu'il soit parfois nécéssaire de le faire. ).
