...
[Vulnérabilité critique (CVSS 10.0) dans React Server Components](https://react.dev/blog/2025/12/03/critical-security-vulnerability-in-react-server-components), annoncée le 3 décembre 2025. 

Elle permet une exécution de code à distance via une requête HTTP malicieuse, touchant React 19.0-19.2.0 et des frameworks comme Next.js.
